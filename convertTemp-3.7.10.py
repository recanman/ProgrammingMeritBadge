...
def convertUSDtoEURO_req5():
   ...
   euro = (int(usd) * 0.87) # Modification: Added int() function to the variable "usd". # This is not completetly accurate, it is based on value from earlier.
   print("This is the amount of money in EURO'S: " + str(euro))

def convertTemp_req4():
   name = input("What is your name?") # Modification: raw_input was removed in Python 3.6.10, changed to input().
   print("Hello, " + name)
